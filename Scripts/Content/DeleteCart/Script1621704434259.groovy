...
WebUI.click(findTestObject('Content/DeleteCart/Page_Amazon.com.tr Elektronik, bilgisayar, _45db13/input_Ne yazk ki erez tercihleriniz kaydedi_db1643'))

WebUI.click(findTestObject('Content/DeleteCart/Page_Amazon.com.tr Elektronik, bilgisayar, _45db13/span_Hesap ve Listeler'))

WebUI.setText(findTestObject('Content/DeleteCart/Page_Amazon Giri Yap/input_E-posta adresi veya telefon numaras_email'), 
