...
WebUI.setText(findTestObject('order address/Page_Amazon Giri Yap/input_E-posta adresi veya telefon numaras_email'), 'serhan-ediz@hotmail.com')

WebUI.click(findTestObject('order address/Page_Amazon Giri Yap/input_E-posta adresinizi veya cep telefonu numaranz girin_continue'))

WebUI.setText(findTestObject('order address/Page_Amazon Giri Yap/Page_Amazon Giri Yap/input_ifremi unuttum_password'), 'Amazon1998')
